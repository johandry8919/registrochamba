<?php
    ...
    class Oferta_empleo_model extends CI_Model {
        ...
        public function obtener_oferta($id = 142){
            // 
            $this->db->select('tbl_ofertas_empleo.*,
            tbl_empresas_entes.nombre_razon_social,tbl_instruccion.nivel,profesion.desc_profesion,
            tbl_areas_formacion.nombre as formacion,tbl_estatus_oferta.descripcion as estatus ,tbl_ofertas_empleo.id_usuario_registro,
        ...
        $this->db->where('tbl_ofertas_empleo.id_usuario_registro', $id);
