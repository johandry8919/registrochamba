        ...
        <div class="container-fluid">
            ...
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-pink">
                    ...
                    <li class="active"><a href="<?php echo base_url();?>redessociales"><i class="material-icons">library_books</i> Redes Sociales</a></li>
                </ol>
            </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="instagram" name="instagram" maxlength="100" autofocus value="<?php if(isset($redesusuario->instagram)) echo ucwords($redesusuario->instagram);?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="facebook" name="facebook" maxlength="200" autofocus value="<?php if(isset($redesusuario->facebook)) echo ucwords($redesusuario->facebook);?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="twitter" name="twitter" maxlength="100" autofocus value="<?php if(isset($redesusuario->twitter)) echo ucwords($redesusuario->twitter);?>">
                                                        </div>
                                                    </div>
                                                </div>                                                
                                            </div><!--row-->
