        ...
        <div class="container-fluid">
            ...
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-pink">
                    ...
                    <li class="active"><a href="<?php echo base_url(); ?>brigadas"><i class="material-icons">library_books</i> Brigadas</a></li>
                </ol>
            </div>
                                ...
                                <div class="row clearfix zindex">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="input-group">
                                            <div class="form-line">
                                                <select class="form-control show-tick" id="id_brigada" name="id_brigada">
