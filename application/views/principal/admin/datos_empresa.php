            ...
            <div class="col-xs-4">
                <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                            ...
                                            <input readonly class="input100 border-start-0 ms-0 form-control" type="email" placeholder="Email" name="email" id="email"
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        required readonly class="form-control show-tick " id="sector_economico" name="sector_economico" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                            ...
                                            <input readonly class="input100 border-start-0 ms-0 form-control"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                            ...
                                            <input  readonly class="input100 border-start-0 ms-0 form-control" type="email" placeholder="Email" name="email_representante" id="email_representante"
                    ...
                    <div class="row m-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select readonly class="form-control show-tick" 
