                    ...
                    <div class="card" >
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <h2 class="p-3">Vivienda Joven</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-5">
                            ...
                            <h3 class="text-center">Elije una opción del Plan Vivienda Joven:</h3>
                        </div>

                        <form id="formacionacademica" method="POST" action="<?php echo base_url(); ?>Cchambistas/registrovivienda" class="login100-form " style="margin: auto;">
