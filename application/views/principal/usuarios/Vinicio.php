    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0);"><img src="<?php echo base_url();?>/img/logo_copia3.png" class="img-fluid" alt="Responsive image"></a>
            </div>
                                ...
                                <ul class="menu tasks">
                                    <li>
                                        <a href="<?php echo base_url();?>Cusuarios/cerrar_session">
                                            <i class="material-icons">lock</i> Cambio Contraseña
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url();?>Cusuarios/cerrar_session">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url();?>Cusuarios/Vinicio">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>Convocatorias / Información</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">
