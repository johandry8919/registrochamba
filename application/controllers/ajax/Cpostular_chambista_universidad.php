...
class Cpostular_chambista_universidad extends CI_Controller {
    ...
    $oferta_chambista=$this->Oferta_universida_model->buscar_oferta_chambista_id($id_usuario,$id_oferta);
    ...
    if($oferta_chambista){
      ...
      $resultado=   $this->Oferta_universida_model->post_regitrar_solicitud([
